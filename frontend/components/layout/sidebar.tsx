                ...
                {hasSubItems && isOpen && (
                  <div className="pl-9 pr-3 py-1 space-y-1 relative">
                    ...
                    {item.subItems!.map((subItem) => {
                      ...
                      // Simple active check for sub-items based on URL path. 
                      // In a real app, you might use IntersectionObserver to update active hashes.
                      // For now, we'll keep it simple and elegant.
                      return (
                        <Link
                          key={subItem.href}
                          href={subItem.href}
