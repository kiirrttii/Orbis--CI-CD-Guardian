...
export const mockIntegrations = [
  {
    ...
    description: 'Automatically runs builds, tests, and deployments whenever code changes are made.',
  ...
  },
  {
    name: 'Ansible',
    category: 'CI/CD & Automation',
    description: 'Helps configure servers and infrastructure without manual setup work.',
    status: 'connected' as const,
  ...
  },
  {
    ...
    description: 'Packages applications so they can run consistently on any machine.',
    status: 'connected' as const,
  ...
  },
  {
    name: 'Kubernetes',
    category: 'Containerization & Orchestration',
    description: 'Keeps applications running smoothly by managing containers automatically.',
    status: 'connected' as const,
  ...
  },
  {
    ...
    description: 'Checks source code for bugs, bad practices, and security risks.',
    status: 'connected' as const,
  ...
  },
  {
    name: 'OWASP ZAP',
    category: 'Security & Code Quality',
    description: 'Scans applications for common security vulnerabilities and attack risks.',
  ...
  },
  {
    ...
    description: 'Collects system performance data like CPU, memory, and service health.',
    status: 'connected' as const,
  ...
  },
  {
    name: 'Grafana',
    category: 'Monitoring & Observability',
    description: 'Turns monitoring data into visual dashboards and live system insights.',
    status: 'connected' as const,
